...
Bit1yke is a link shortening Ruby on Rails API similar to [bitly](https://bitly.com/). I had built a link shortener in the past for a code challenge but wanted to re-visit the idea from scratch while following best practices as I now understand them. This project is built and auto-deploys using [Heroku Pipelines](https://devcenter.heroku.com/articles/pipelines) and [CircleCI](https://app.circleci.com/pipelines/github/Patrick-Duvall/bit1yke).
